...
[![Coverage Status](https://coveralls.io/repos/github/hazendaz/whitespace-maven-plugin/badge.svg?branch=master)](https://coveralls.io/github/hazendaz/whitespace-maven-plugin?branch=master)
